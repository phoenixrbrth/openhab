 ...
 * {@link LutronBindingProvider} service as well.
 * </p>
 * 
 * <p>
 ...
 * @since 0.9.0
 */
public class LutronGenericBindingProvider extends AbstractGenericBindingProvider implements LutronBindingProvider {

	static final Logger logger = LoggerFactory.getLogger(LutronGenericBindingProvider.class);
	 ...
	 * @throws BindingConfigParseException
	 */
	private void parseBindingConfig(LutronBindingConfig config, Item item, String bindingConfig)
			throws BindingConfigParseException {
		...
		if (bindingConfig != null) {
			...
			if (!outMatcher.matches() && !inMatcher.matches()) {
				...
				LutronBindingConfigElement newElement = new LutronBindingConfigElement();
	...
	public List<String> getInBindingItemNames() {
		...
		for (String itemName : bindingConfigs.keySet()) {
			LutronBindingConfig snmpConfig = (LutronBindingConfig) bindingConfigs.get(itemName);
	...
	public Class<? extends Item> getItemType(String itemName) {
		LutronBindingConfig config = (LutronBindingConfig) bindingConfigs.get(itemName);
	...
	static class LutronBindingConfig extends HashMap<Command, LutronBindingConfigElement> implements BindingConfig {
	 ...
	 * provider.
	 */
	static class LutronBindingConfigElement implements BindingConfig {
		public OID oid;
		...
		public boolean setTransformationRule(String rule) {
			...
			BundleContext context = LutronActivator.getContext();
